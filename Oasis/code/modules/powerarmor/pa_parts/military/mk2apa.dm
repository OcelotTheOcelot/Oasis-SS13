/obj/item/power_armor_part/torso/mk2apa
	name = "Mk. II APA chestplate"
	desc = "<TODO>"
	icon = 'Oasis/icons/powerarmor/parts/mk2apa.dmi'
	slowdown = 0.4
	render_priority = 5
